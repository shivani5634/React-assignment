...
import { useMediaQuery } from "../misc/custom-hookss";
import "../styles/main.scss";

const Instance = () => {
  const { isMobile } = useMediaQuery("(max-width:992px)");
  return (
    <div className="rs-carousel-slider mx-auto">
      <Carousel autoplay className="custom-slider mt-3 mx-auto" full={isMobile}>
        <img
